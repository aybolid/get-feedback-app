...
const SiteFeedback = ({ feedback }) => {
  ...
  return (
    <>
      ...
      />
      <section className="bg-white dark:bg-neutral-800 w-full h-full p-4 mx-auto my-0 text-neutral-700 dark:text-neutral-50">
        ...
        <section className="max-h-screen dark:bg-neutral-700 bg-neutral-100 rounded-lg overflow-x-hidden overflow-y-auto">
          ...
          {feedback?.map((feedback) => (
            <div className="px-4 my-2" key={feedback.id}>
